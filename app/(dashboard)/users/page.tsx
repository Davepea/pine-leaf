...
import UsersTable from '@/components/dashboard-components/table/UsersTable'
                ...
                <div className="flex justify-between items-center">
                    <form action="" className='h-[50px] md:w-[386px] w-[185px]'>
                        <label htmlFor="search" className='md:px-5 px-3 border border-[#2F5318]/20 h-full w-full rounded-[10px] flex items-center text-[#000000]/40'>
                            <input type="text" name="search" id="search" placeholder='Search users' className='h-[45px] w-full outline-none border-none placeholder:text-[#000000]/80' />
                            <MdSearch size={22} />
                        </label>
                    </form>
