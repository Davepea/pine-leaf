...
const contents = [
    ...
    },
    {
        ...
        url: '/admin/create-testimonials'
    },
    {
        id: 10,
        name: 'News Subscribers',
        icon: <MdOutlineUnsubscribe size={22} />,
        svg: (
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_845_1562)">
                    <path d="M11.0007 1.83325C5.94065 1.83325 1.83398 5.93992 1.83398 10.9999C1.83398 16.0599 5.94065 20.1666 11.0007 20.1666C16.0607 20.1666 20.1673 16.0599 20.1673 10.9999C20.1673 5.93992 16.0607 1.83325 11.0007 1.83325ZM11.0007 18.3333C6.95815 18.3333 3.66732 15.0424 3.66732 10.9999C3.66732 6.95742 6.95815 3.66659 11.0007 3.66659C15.0432 3.66659 18.334 6.95742 18.334 10.9999C18.334 15.0424 15.0432 18.3333 11.0007 18.3333Z" fill="white" />
        ...
        url: '/admin/news-subscribers'
    },
    {
        id: 11,
        name: 'Consultation',
        icon: <RiKakaoTalkLine size={22} />,
        svg: (
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_845_1562)">
                    <path d="M11.0007 1.83325C5.94065 1.83325 1.83398 5.93992 1.83398 10.9999C1.83398 16.0599 5.94065 20.1666 11.0007 20.1666C16.0607 20.1666 20.1673 16.0599 20.1673 10.9999C20.1673 5.93992 16.0607 1.83325 11.0007 1.83325ZM11.0007 18.3333C6.95815 18.3333 3.66732 15.0424 3.66732 10.9999C3.66732 6.95742 6.95815 3.66659 11.0007 3.66659C15.0432 3.66659 18.334 6.95742 18.334 10.9999C18.334 15.0424 15.0432 18.3333 11.0007 18.3333Z" fill="white" />
    ...
    {
        id: 13,
        name: 'Contact Us Input',
        icon: <MdOutlineContactEmergency size={22} />,
        svg: (
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_845_1562)">
                    <path d="M11.0007 1.83325C5.94065 1.83325 1.83398 5.93992 1.83398 10.9999C1.83398 16.0599 5.94065 20.1666 11.0007 20.1666C16.0607 20.1666 20.1673 16.0599 20.1673 10.9999C20.1673 5.93992 16.0607 1.83325 11.0007 1.83325ZM11.0007 18.3333C6.95815 18.3333 3.66732 15.0424 3.66732 10.9999C3.66732 6.95742 6.95815 3.66659 11.0007 3.66659C15.0432 3.66659 18.334 6.95742 18.334 10.9999C18.334 15.0424 15.0432 18.3333 11.0007 18.3333Z" fill="white" />
    ...
    },
    {
        id: 14,
        name: 'Inspection',
        icon: <TbDeviceImacSearch size={22} />,
        svg: (
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_845_1562)">
                    <path d="M11.0007 1.83325C5.94065 1.83325 1.83398 5.93992 1.83398 10.9999C1.83398 16.0599 5.94065 20.1666 11.0007 20.1666C16.0607 20.1666 20.1673 16.0599 20.1673 10.9999C20.1673 5.93992 16.0607 1.83325 11.0007 1.83325ZM11.0007 18.3333C6.95815 18.3333 3.66732 15.0424 3.66732 10.9999C3.66732 6.95742 6.95815 3.66659 11.0007 3.66659C15.0432 3.66659 18.334 6.95742 18.334 10.9999C18.334 15.0424 15.0432 18.3333 11.0007 18.3333Z" fill="white" />
...
const pageTitles: Record<string, React.ReactNode> = {
    ...
    '/admin/users': 'Users',
    '/admin/transactions': (
        <div className='flex gap-1'>Transactions <span className='md:block hidden'>(Outgoing Payments)</span></div>
    ),
    '/admin/upload': 'Upload Property',
    '/admin/proofs': (
        <div className='flex gap-1'>Proofs <span className='md:block hidden'>(Of Property Sold)</span></div>
    ),
    '/admin/referral-earnings': 'Referral Earnings',
    '/admin/realtors-reg': 'Realtors Stars',
    '/admin/create-testimonials': 'Create Testimonials',
    '/admin/news-subscribers': 'New Subscribers',
    '/admin/consultation': 'Consultation',
    '/admin/gallery': 'Gallery',
    '/admin/contact-us': 'Contact Input',
            ...
            <div className="drawer-content">
                <div className="w-full flex justify-between items-center text-[#000000]/80 py-3 backdrop-blur-2xl">
                    ...
                    <div className="flex items-center md:gap-5 gap-3">
                        {shouldShowSearch && (
                            <form action="" className='h-[40px] w-[280px] md:block hidden'>
                                <label htmlFor="search" className='px-5 border border-[#2F5318]/50 h-full w-full rounded-full flex items-center text-[#000000]/40'>
                                    <input type="text" name="search" id="search" placeholder='Search' className='h-[40px] w-full outline-none border-none placeholder:text-[#000000]/40' />
                                    <MdSearch size={22} />
                                </label>
                            </form>
                        ...
                        {!shouldHideProfile && (
                            <div className="flex items-center md:gap-3 gap-2">
                                ...
                                <div className="dropdown dropdown-end">
                                    <div tabIndex={0} role="button" className="flex items-center gap-[10px] md:text-sm text-xs">
                                        <Image src='/images/dashboard/profile.png' width={40} height={40} alt='logo' objectFit='cover' objectPosition='center' className='md:size-[40px] size-[30px] rounded-full border border-[#2F5318]' />
                                        <div className="flex items-center gap-2">
                                            Admin
