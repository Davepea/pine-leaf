...
import { MdMessage, MdOutlineAccountBalanceWallet, MdOutlineAllInbox, MdOutlineConnectWithoutContact, MdOutlineContactEmergency, MdOutlineDashboard, MdOutlineGroupWork, MdOutlinePayments, MdOutlinePeopleAlt, MdOutlineUnsubscribe, MdVerified } from 'react-icons/md'
...
const Sidebar = () => {
    ...
    return (
        <div className='md:block hidden'>
            <div className="w-[250px] h-screen flex flex-col gap-10 justify-between bg-[#2F5318] text-white pt-5">
                ...
                <ul className='flex flex-col gap-1 px-3 py-2 h-full overflow-y-auto'>
                    {contents.map(content => (
                        <li key={content.id}>
                            <Link
                                href={content.url}
                                className={`w-full rounded-[10px] px-3 h-[50px] flex items-center gap-3 font-medium text-base leading-5 ${isActive(content.url)
