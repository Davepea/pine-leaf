...
const pageTitles: Record<string, string> = {
    ...
    '/users': 'Users',
    '/transactions': 'Transactions (Outgoing Payments)',
    '/upload': 'Upload Property',
    '/proofs': 'Proofs (Of Property Sold)',
    '/referral-earnings': 'Referral Earnings',
    '/realtors-reg': 'Realtors Registration (First-time paid signups)',
    '/salary-log': 'Salary Logs',
}
