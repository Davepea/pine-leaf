            ...
            <form action="" className='grid grid-cols-2 gap-x-9 gap-y-5'>
                <label htmlFor="" className='font-normal text-lg flex flex-col gap-1'>Email
                    <div className="flex items-center gap-4 px-[10px] h-[55px] w-full border border-[#2F5318]/80 rounded-[10px]">
                        ...
                        <span className='w-max bg-transparent text-black/80 text-sm font-medium border border-[#2F5318]/20 rounded-[10px] flex items-center px-5 h-[35px]'>okofodaniel20@gmail.com</span>
                    </div>
                </label>
                <label htmlFor="" className='font-normal text-lg flex flex-col gap-1'>Referral Code
                    <div className="flex items-center gap-4 px-[10px] h-[55px] w-full border border-[#2F5318]/80 rounded-[10px]">
                        ...
                        <span className='w-max bg-transparent text-black/80 text-sm font-medium border border-[#2F5318]/20 rounded-[10px] flex items-center px-5 h-[35px]'>0ce4bff0</span>
                    </div>
                </label>
                <label htmlFor="" className='font-normal text-lg flex flex-col gap-1'>Phone Number
                    <div className="flex items-center gap-4 px-[10px] h-[55px] w-full border border-[#2F5318]/80 rounded-[10px]">
                        ...
                        <span className='w-max bg-transparent text-black/80 text-sm font-medium border border-[#2F5318]/20 rounded-[10px] flex items-center px-5 h-[35px]'>08199225678</span>
                    </div>
                </label>
