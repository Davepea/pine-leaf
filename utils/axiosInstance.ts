...
export const fetchAllProperty = ()=>API.get(`/public/api/properties`)
export const fetchEachUser = ()=> API.get(`/public/api/user`)
...
export const fetchEachProperty = (user_id:number)=> API.get(`/public/api/properties/${user_id}`)

export const fetchActivityLog = (user_id:number)=> API.get(`/public/api/activity-logs/user/${user_id}`)
export const fetchNotification = (user_id:number)=> API.get(`/public/api/notification/user/${user_id}`)
...
export const fetchTransaction = ()=> API.get(`public/api/admin/transactions`)
...
export const purchase = (data:object)=> API.post(`/public/api/purchase`, data)
